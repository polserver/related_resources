	...
	public class GenTeleporter
	{
		...
		public class TeleportersCreator
		{
			...
			public void CreateTeleportersMap( Map map )
			{
				...
				CreateTeleporter( 3011, 902,   0, 5213, 1842,  7, map, true );
				CreateTeleporter( 5213, 1842,  7, 3011, 902,   0, map, true );
				CreateTeleporter( 5214, 1843,  7, 3011, 902,   0, map, true );

				// Britain Sewer

				CreateTeleporter( 3029, 1069, -8, 5809, 2604, 17, map, true );
				CreateTeleporter( 5809, 2604, 17, 3029, 1069, -8, map, true );
