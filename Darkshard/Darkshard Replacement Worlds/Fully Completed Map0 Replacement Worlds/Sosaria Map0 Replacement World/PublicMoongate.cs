	...
	public class PMList
	{
		...
		public static readonly PMList Trammel =
			new PMList( 1012000, 1012012, Map.Trammel, new PMEntry[]
				{
    					new PMEntry( new Point3D(  966,  516, 1 ), 1005397 ), // Moon
    					new PMEntry( new Point3D( 3727, 2153, 0 ), 1005397 ), // Clues Island
    					new PMEntry( new Point3D( 2553, 2686, 0 ), 1005397 ), // Montor
    					new PMEntry( new Point3D( 1922, 1507, 2 ), 1005397 ), // Devil Guard
    					new PMEntry( new Point3D( 2553, 2686, 0 ), 1005397 ), // Montor
    					new PMEntry( new Point3D(  966,  516, 1 ), 1005397 ), // Moon  
    					new PMEntry( new Point3D( 1459, 1414, 0 ), 1005397 ), // Mountain Passage (Gate to Exodus Isle)
    					new PMEntry( new Point3D( 3831, 1502, 0 ), 1005397 ), // Time Awaits
    					new PMEntry( new Point3D(  965, 2730, 0 ), 1005397 ), // The moongate is cloudy, and nothing can be made out.
				} );
